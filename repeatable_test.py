...
def main():
    ...
    while True:
        try:
            ...
            print(
                f"💥 Erro durante o scraping (Tentativa {attempt}): {error_type} - {error_message}")
            ...
            print(
                f"⏳ Aguardando {delay:.2f} segundos antes de tentar novamente...")
            time.sleep(delay)
    ...
    # Indica que o processo de scraping terminou (com sucesso ou após tentativas)
    return True
